    ...
    <section id="about" className="bg-cream text-brand">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-20 md:grid-cols-12 md:px-12 md:py-28">
        ...
        <div className="space-y-6 text-base leading-relaxed text-brand/75 md:col-span-7 md:col-start-6">
          <p>
            Rooted in informal community activity dating back to 2014, the Association formally registered as a society in August 2026. We create a welcoming home for Batswana living in Alberta and introduce Calgary audiences to Botswana’s music, dance, storytelling, cuisine, visual arts, and traditions.
          </p>
          <p>
